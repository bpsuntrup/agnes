use utf8;
package App::Agnes::Schema::Result::UserAttributeType;
...
App::Agnes::Schema::Result::UserAttributeType
...
=head1 TABLE: C<user_attribute_types>

=cut

__PACKAGE__->table("user_attribute_types");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SlogDTlXxVFVchFewWdt/w
